...
class ModalComponent extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            image: this.props.editMode ? this.props.infos.image : '',
                ...
                <Modal show={this.state.show} onHide={this.handleShow}>
                    ...
                    <Modal.Body>
                        <div>
                            ...
                            <div className="md-form mb-5">
                                {/* <label>Picture:</label> */}
                                <input type="text" onChange={this.handleChange} name="image" value={this.state.image} placeholder="link picture" className="form-control validate" />
                            </div>
                            <div className="md-form mb-5">
                                {/* <label>Date:</label> */}
...
const mapDispatchToProps = dispatch => {
    return {
        addNewMovie: x => dispatch(addMovie(x)),
